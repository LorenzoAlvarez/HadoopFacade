...
public class TestCopyToLocal 
{
    public static void main( String[] args )
    {
    	...
    	try {
			...
			//Function:
			String src = "/user/cloudera/weather/1901";
			String localDst = "/home/zito/Documentos/hola";
			
			if (facadeHDFS.cpToLocal(src, localDst))
				System.out.println("File" + src + "copied!");
			
			else
				System.out.println("File" + src + " not copied, check your local path");
