...
public class TestMvFromLocal 
{
    public static void main( String[] args )
    {
    	...
    	try {
			...
			if (facadeHDFS.mvFromLocal(localSrc, dst))
				System.out.println("File" + localSrc + " moved!");
			
			else
				System.out.println("File" + localSrc + " not moved, check your local path");
